...
class PointTowards extends StatefulWidget {
  const PointTowards({Key? key}) : super(key: key);

  @override
  State<PointTowards> createState() => _PointTowardsState();
}

class _PointTowardsState extends State<PointTowards> {
    ...
    return Stack(
      children: [
        CustomPaint(
          ...
          painter: BlockA(extensionLength: 125.0, color: Colors.blue),
